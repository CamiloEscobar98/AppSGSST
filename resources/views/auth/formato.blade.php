        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <h3 class="text-left">A continuación marque con una X</h3>
                    <div class="row">
                        <div class="col-12-col-md-12 col-lg-12 col-xl-6">
                            <div class="form-group">
                                <label for="">Tipo de Contratación/Vinculación</label>
                        ...
                        <div class="col-12-col-md-12 col-lg-12 col-xl-6">
                            <div class="form-group">
                                <label for="">Rol en la Institución</label>
                                <select class="form-control" name="" id="">
                                    <option value="-1">Seleccione una opción por favor</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 col-lg-12 col-xl-4">
                            <div class="form-group">
                                <label for="razon_social" class="font-weight-bold">Teléfono o Celular</label>
                                <input type="text" name="razon_social" id="razon_social" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                                @error('razon_social')
                                    <small id="helpId" class="bg-translucent-danger">{{ $message }}</small>
                        ...
                        <div class="col-12 col-md-12 col-lg-12 col-xl-4">
                            <div class="form-group">
                                <label for="razon_social" class="font-weight-bold">Correo Electrónico</label>
                                <input type="email" name="razon_social" id="razon_social" class="form-control"
                    ...
                    <div class="row">
                        <div class="col-12-col-md-12 col-lg-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" id="fullname" class="form-control"
                                    value="{{ auth()->user()->fullname() }}" aria-describedby="helpId" disabled>
                                @error('fullname')
                                    <small id="helpId" class="bg-translucent-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="document_type" class="font-weight-bold">Tipo de identificación (CC, CE, TI, PA,
                                    etc.)</label>
                                <input type="text" name="document_type" id="document_type"
                                    class="form-control text-capitalize"
                                    value="{{ auth()->user()->document->document_type->info }}" aria-describedby="helpId"
                                    disabled>
                                @error('document_type')
                                    <small id="helpId" class="bg-translucent-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="document" id="document" class="form-control text-capitalize"
                                    value="{{ auth()->user()->document->document }}" aria-describedby="helpId" disabled>
                                @error('document')
                                    <small id="helpId" class="bg-translucent-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-12-col-md-12 col-lg-12 col-xl-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cargo" id="cargo" class="form-control" aria-describedby="helpId"
                    ...
                    <div class="list-group">
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12 col-xl-6">
                                ...
                                <a class="list-group-item list-group-item-action">3. Responsabilidades del trabajador en SST
                                    (decreto
                                    1072/2015 y normas de SST)</a>
                                <a class="list-group-item list-group-item-action">4. Reglamento de Higiene y Seguridad
                                    Industrial</a>
                                <a class="list-group-item list-group-item-action">5. Prevención en el consumo de alcohol,
                                    tabaco y
                                    drogas.</a>
                                <a class="list-group-item list-group-item-action">6. Sistema general de riesgos laborales
                                    -SGRL
                            ...
                            <div class="col-12 col-md-12 col-lg-12 col-xl-6"> <a
                                ...
                                <a class="list-group-item list-group-item-action">9. Seguridad vial (conductores, pasajeros
                                    o
                                    peatones)</a>
                                <a class="list-group-item list-group-item-action">10. Gestión multidisciplinar de los
                                    peligros /
                                    riesgos</a>
                                <a class="list-group-item list-group-item-action">11. Actuaciones en caso de Accidente de
                                    Trabajo- AT,
                                    Incidente de Trabajo - IT y - Enfermedad</a>
                                <a class="list-group-item list-group-item-action">12. Actuaciones en caso de emergencias:
                                    plan,
                                    rutas de
                                    evacuación, puntos de encuentro, etc.</a>
                                <a class="list-group-item list-group-item-action">13. Aspectos básicos de primeros auxilios
                                    y
                                    servicio
                                    de área protegida</a>
                                <a class="list-group-item list-group-item-action">14. Comité paritario de seguridad y salud
                                    en
                                    el
