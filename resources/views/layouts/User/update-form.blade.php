    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId"
                    placeholder="Escribe tu nombre.." value="{{ Auth()->user()->name }}"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="lastname" id="lastname" aria-describedby="helpId"
                    placeholder="Escribe tu nombre.." value="{{ Auth()->user()->lastname }}"
                    {{ session('role') != 'administrador' ? 'disabled' : '' }}>
                @error('lastname')
                    <small id="helpId"
                        class="form-text bg-danger font-weight-bold py-2 text-white px-2">{{ $message }}</small>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone" id="phone" aria-describedby="helpId"
                    placeholder="Escribe tu nombre.." value="{{ Auth()->user()->phone }}">
                @error('phone')
                    <small id="helpId"
                        class="form-text bg-danger font-weight-bold py-2 text-white px-2">{{ $message }}</small>
                @enderror
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="document" id="document" aria-describedby="helpId"
